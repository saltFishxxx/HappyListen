									...
									<tr>
														...
														<td style="text-align:center">
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input class="border-radis" name="username"
																		type="text" class="textinput" />
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right; padding-top:5px">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
																	<td style="text-align:left"><input class="border-radis" name="password"
																...
																<tr>
																	<td colspan="2"
																		...
																		href="${pageContext.request.contextPath}/jsp/register.jsp"><img name="image"
										...
										<td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
											...
											<p style="text-align:center">
												<a href="${pageContext.request.contextPath}/jsp/register.jsp"><img
