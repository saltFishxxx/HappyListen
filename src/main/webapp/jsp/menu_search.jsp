...
<div id="divmenu">
	...
	<a href="${pageContext.request.contextPath}/product/showProductByPage"
		style="color:#000">全部商品目录</a>
	<a style="margin-right: -174px; padding-left: 56px;">
		<marquee width="100">David Arkenstone - Gentle Rain</marquee>
	</a>
</div>
<%--<div id="divsearch">--%>
	...
	<%--</form>--%>
<%--</div>--%>
<div style="display: none"><audio src="../music/David Arkenstone - Gentle Rain.mp3" autoplay loop></audio></div>
<div id="content"
