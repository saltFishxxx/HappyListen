								...
								<td><table width="100%" border="0" cellspacing="0">
										<tr>
											<td><img src="../images/buy2.gif" width="635" height="38" />
												<p>您好：${usser.username}先生！欢迎您来到商城结算中心</p></td>
										</tr>
										<tr>
											<td><table cellspacing="1" class="carttable">
												...
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%">88￥</td>
														<td width="10%">文学</td>
														<td width="10%"><span style="margin-left: 5px;">1</span></td>
														<td width="10%">88￥</td>
												...
												<table cellspacing="1" class="carttable">
													<tr>
														<td style="text-align:right; padding-right:40px;"><font
															style="color:#FF0000">合计：&nbsp;&nbsp;88元</font></td>
													</tr>
												</table>
												...
												<p style="text-align:right">
													<a href="${pageContext.request.contextPath}/jsp/pay.jsp"><img src="../images/gif53_029.gif" width="204" height="51"
															border="0" /></a>
												</p></td>
										</tr>
									</table></td>
