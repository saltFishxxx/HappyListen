				...
				<tr>
					<td style="padding:30px">
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								<td></td>
								<td><h3 style="color: red;">${error}</h3></td>
								<td></td>
							</tr>
							<tr>
								<td style="text-align:right; width:20%">会员邮箱：</td>
								<td style="width:40%">
								<input type="text" class="textinput border-radis"
									name="email" /></td>
							...
							<tr>
								...
								<td>
									<input type="text" class="textinput border-radis" name="username" />
								</td>
								<td><font color="#999999">用户名设置至少6位</font></td>
							</tr>
							<tr>
								<td style="text-align:right">密码：</td>
								<td><input type="password" class="textinput border-radis"
									name="password" /></td>
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="textinput border-radis"
									style="width:350px" name="telephone" /></td>
							</tr>
							<tr>
								<td style="text-align:right">个人介绍：</td>
								<td colspan="2"><textarea class="textarea border-radis" name="introduce"></textarea>
								</td>
							</tr>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width:50%"><input type="text" class="textinput border-radis" name="verifyCode"/>
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
